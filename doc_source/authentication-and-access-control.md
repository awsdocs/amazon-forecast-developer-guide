...
+ [Using Identity\-based Policies \(IAM Policies\) for Amazon Forecast](using-identity-based-policies.md)
+ [Amazon Forecast API Permissions: Actions, Permissions, and Resources Reference](api-permissions-reference.md)